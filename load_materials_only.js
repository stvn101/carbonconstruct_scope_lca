/**
 * Load Materials Only
 * Run this AFTER recreating the table and waiting 30 seconds
 */
...
async function main() {
    console.log('📦 Loading Materials into Supabase\n');
    ...
    try {
        ...
        try {
            ...
            console.log('Please wait 30 more seconds and try again.\n');
            process.exit(1);
        }
